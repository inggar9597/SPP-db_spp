...
if( empty( $_SESSION['iduser'] ) ){
   ...
   if( isset( $_REQUEST['sub'] )){
      ...
      if(isset($_REQUEST['submit'])){
         ...
         //echo $tgl1.'-'.$tgl2;
         $q = "SELECT kelas,sum(jumlah) FROM tb_transaksi WHERE tgl_transaksi BETWEEN '$tgl1' AND '$tgl2' GROUP BY kelas";
         ...
         $tgl = date("Y/m/d");
         $q = "SELECT kelas,sum(jumlah) FROM tb_transaksi WHERE tgl_transaksi='$tgl' GROUP BY kelas";
